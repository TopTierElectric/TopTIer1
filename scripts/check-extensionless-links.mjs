...
if (issues.length) {
  console.error('❌ Found root-absolute .html links. Use extensionless canonical paths on Cloudflare Pages.');
...
console.log(`✅ Extensionless link check passed (${htmlFiles.length} HTML files scanned).`);
