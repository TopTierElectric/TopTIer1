...
export function filePathToRoute(pagesRoot, filePath) {
...
export function routeToOutFile(distRoot, route) {
  if (route === "/") return path.join(distRoot, "index.html");
  return path.join(distRoot, route.replace(/^\//, ""), "index.html");
}
export function canonicalUrl(siteDomain, route) {
  const d = siteDomain.replace(/\/$/, "");
