...
- **`contact.html`** – Contact page with phone, email and a form ready to connect to a submission handler.
...
This site can be deployed to any static web server. The three on-page forms submit to a placeholder endpoint at `https://formsubmit.co/your-email@example.com`. Replace that URL with your preferred form handler before going live.
