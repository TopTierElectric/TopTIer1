...
- **Do not remove all redirects.** Keep the path/legacy redirects in `_redirects` unless the *same path rules* are migrated to Cloudflare Redirect Rules/Bulk Redirects.
